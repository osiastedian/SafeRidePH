    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        switch (seekBar.getId()) {
            case R.id.bumpSeekbar: {
                ...
                bumpTextView.setText(String.format(Locale.ENGLISH, "Bump Threshold: %.2f", percent  * BumpDetectionSystem.MAX_THRESHOLD));
                break;
            }

            case R.id.scannedRadiusSeekBar: {
                scanRadiusTextView.setText(String.format(Locale.ENGLISH, "Scanned Radius: %d meters", getRadiusInMeters()));
                break;
            }
